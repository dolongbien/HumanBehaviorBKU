...
% This code save already computed C3D features into 64 (video features) segments.
...
for ifolder=1:length(All_Folder)
  ...
  %% 32 Segments
     ...
     Segments_Features=zeros(64,4096);
     thirty2_shots= round(linspace(1,length(AllFiles),65));
     count=0;
