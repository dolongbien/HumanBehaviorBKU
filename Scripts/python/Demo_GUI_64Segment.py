...
import os, sys
import pickle
from PyQt5 import QtWidgets, QtWidgets   # If PyQt4 is not working in your case, you can try PyQt5, 
...
class PrettyWidget(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        Model_dir = '/home/dlbien/Documents/AnomalyDetectionCVPR2018/'
        weights_path = Model_dir + 'Weigh_RoadAcc_64SegArch2LOSS210000.mat'
        model_path = Model_dir + 'model_64SegArch2Loss2.json'
        ########################################
    ...
    def SingleBrowse(self):
        video_path, _ = QtWidgets.QFileDialog.getOpenFileName(self,
                                                        'Single File',
                                                        "/home/dlbien/Documents/AnomalyDetectionCVPR2018/SampleVideo_RoadAccident")

        print(video_path)
        cap = cv2.VideoCapture(video_path)
        #Total_frames = cap.get(cv2.CV_CAP_PROP_FRAME_COUNT)
        Total_frames = cap.get(cv2.CAP_PROP_FRAME_COUNT)
        total_segments = np.linspace(1, Total_frames, num=65)
        total_segments = total_segments.round()
        FeaturePath=(video_path)
        FeaturePath = FeaturePath[0:-4]
        FeaturePath = FeaturePath+ '_64seg_C.txt'
